...
namespace Drillholes.Domain.Services
{
    public class SurveyDesurveyServices
    {
        ...
        public async Task<SurveyDesurveyObject> SurveyDownhole(IMapper mapper, DrillholeDesurveyEnum desurveyType, ImportTableFields tableFields, bool bToe, List<XElement> surveyValues)
        {
            var desurvDto = await _drillhole.CreateSurveyDownhole(desurveyType, tableFields, bToe, surveyValues) as SurveyDesurveyDto;
