...
namespace Drillholes.Domain.DataObject
{
    public class CollarTableObject
    {
      ...
      //  public TestMessages testMessages { get; set; }
        ...
        public CollarTableObject()
        {

        }

        public CollarTableObject(bool _isValid)
        {
            tableIsValid = _isValid;
        }

        public CollarTableObject(string _tableLocation)
        {
            tableLocation = _tableLocation;
        }

        public CollarTableObject(string _tableLocation, bool _isValid)
        {
        ...
        public virtual void ReadInputValues()
        {
            if (tableIsValid)
            {
        ...
        public void SetCollarIDs()
        {
            collarIDs = new List<string>();
        }
    }
